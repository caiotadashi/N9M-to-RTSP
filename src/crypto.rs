...
pub fn hmac_md5_hex(key: &[u8], data: &[u8]) -> String {
    let mut k = [0u8; 64];
    if key.len() > 64 {
...
mod tests {
    ...
    #[test]
    fn n9m_verify_vector() {
        let key = b"45792d55-0844-4053-848a-64fd0685fb32";
        assert_eq!(
            hmac_md5_hex(key, key),
            "fae5f19b8452c7bd03dc4f3471966c42"
        );
    }
}
